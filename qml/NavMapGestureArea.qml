// NavMapGestureArea — copia de MapboxMapGestureArea.qml de mapbox-gl-qml con
// los parches propios que Navius lleva en Ubuntu Touch (lib/MapboxMap/): el
// pinch también ROTA el mapa (bearing) y mantiene el punto bajo los dedos como
// pivote. En postmarketOS el plugin MapboxMap viene del paquete del sistema
// (sin parchear), así que la versión parcheada se embebe aquí y Main.qml usa
// este componente en vez del MapboxMapGestureArea del plugin.
import QtQuick 2.0
...
Item {
    ...
    id: mpbxGestureArea  // copia parcheada de MapboxMapGestureArea.qml (pinch con rotación y pivote), ver cabecera
